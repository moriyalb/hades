 ...
 *
 * @param {String} pushMapId message push Id
 ...
 * @memberOf ChannelService
 */
ChannelService.prototype.pushMessageByUids = function (pushMapId, msg, uids, opts, cb) {
	...
	sendMessageByGroup(this, pushMapId, msg, groups, opts, cb);
};
 ...
 * @memberOf ChannelService
 */
ChannelService.prototype.broadcast = function (stype, pushMapId, msg, opts, cb) {
	var app = this.app;
	var namespace = 'sys';
	...
	var sendMessage = function (serverId) {
		return (function () {
			if (serverId === app.serverId) {
				self.channelRemote[method](pushMapId, msg, opts, genCB());
			} else {
				app.rpcInvoke(serverId, {
					namespace: namespace,
					service: service,
					method: method,
					args: [pushMapId, msg, opts]
				}, genCB(serverId));
			}
		}());
	};
 ...
 */
Channel.prototype.pushMessage = function (pushMapId, msg, opts, cb) {
	if (this.state !== ST_INITED) {
	...
	sendMessageByGroup(this.__channelService__, pushMapId, msg, this.groups, opts, cb);
};
 ...
 *
 * @param pushMapId {String} pushMapId push map id
 ...
 * @api private
 */
var sendMessageByGroup = function (channelService, pushMapId, msg, groups, opts, cb) {
	...
	var sendMessage = function (sid) {
		return (function () {
			if (sid === app.serverId) {
				channelService.channelRemote[method](pushMapId, msg, groups[sid], opts, rpcCB(sid));
			} else {
				app.rpcInvoke(sid, {
					namespace: namespace,
					service: service,
					method: method,
					args: [pushMapId, msg, groups[sid], opts]
				}, rpcCB(sid));
			}
		})();
	};
