...
utils.headHandler = function (headBuffer, isLong = false) {
	var len = 0;
	//console.log("xxxxxxxxxx headBuffer ", headBuffer)
	if (isLong) {
		for (var i = 1; i < 4; i++) {
			if (i > 1) {
				len <<= 8;
	...
	//console.log("utils headHandler check length -> ", len)
	return len;
};
