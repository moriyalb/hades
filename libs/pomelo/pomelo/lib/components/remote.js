...
var RemoteServer = Hades.Rpc.server;
...
var getRemotePaths = function (app) {
	...
	let record = Hades.CommunicateMgr.getRemoteHandle(serverType)
	paths.push(pathUtil.remotePathRecord('user', serverType, record))
