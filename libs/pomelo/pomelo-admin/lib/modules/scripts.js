...
var list = function(scriptModule, agent, msg, cb) {
    ...
    fs.readdir(path.join(scriptModule.app.base,"Project/Scripts"), function(err, filenames) {
        if (err) {
            filenames = [];
        }
...
var save = function(scriptModule, agent, msg, cb) {
    var filepath = path.join(scriptModule.app.base,"Project/Scripts", msg.filename);
